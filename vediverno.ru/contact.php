...
class Send {
    ...
    public function index(){
            ...
            if (($this->request->server['REQUEST_METHOD'] == 'POST') && $this->validate()) {
                ...
                $message .= '<p>Имя: '.$this->request->post['Name-Lastform'].'</p>';
                $message .= '<p>Телефон: '.$this->request->post['Phone-Lastform'].'</p>';
    ...
    private function validate(){
        ...
        if ((utf8_strlen($this->request->post['Phone-Lastform']) < 10) || (utf8_strlen($this->request->post['Phone-Lastform']) > 32)) {
			$this->error['Phone-Lastform'] = 'Укажите свой телефон';
        }
